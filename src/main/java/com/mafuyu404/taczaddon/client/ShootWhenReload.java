...
public final class ShootWhenReload {
    ...
    public static boolean canInterruptForImmediateShot(
        ...
        return com.mafuyu404.taczaddon.common.ShootWhileReloadService.hasLoadedAmmo(
                gun.getCurrentAmmoCount(gunStack), gun.hasBulletInBarrel(gunStack), gunData.getBolt());
    }
